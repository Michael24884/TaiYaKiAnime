    ...
    children: [
      ...
      if (state.statusDistribution.first.dataSource!.isNotEmpty)
        ...
        child: Card(
          child: SfCircularChart(
            ...
            legend: Legend(
                isVisible: true,
                textStyle:  TextStyle(color: Theme.of(viewService.context).textTheme.bodyText1!.color)),
          ),
        ),
      ),
      ...
      Padding(
          ...
          child: SizedBox(
            ...
            child: Card(
              child: state.trendsAverageScore.first.dataSource.length <= 1 ? Center(child: Text('No trending average score data recorded')) : SfCartesianChart(
      ...
      Padding(
        ...
        child: SizedBox(
          height: TaiyakiSize.height * 0.34,
          child: Card(
            child: state.trendsWatchers.first.dataSource.length <= 1 ? Center(child: Text('No trending data recorded')) : SfCartesianChart(
