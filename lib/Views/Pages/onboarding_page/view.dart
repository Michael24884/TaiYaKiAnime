                  ...
                  child: Animator(
                    ...
                    builder: (ctx, state, _) => FractionalTranslation(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () => dispatch(OnboardingActionCreator.moveToPage(null))
                      ),
                    ),
                  )),
            ),
    ...
    body: PageView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
          switch(index) {
            ...
            case 1: return viewService.buildComponent('page_one');
            case 2: return viewService.buildComponent('page_two');
            case 3: return viewService.buildComponent('page_three');
            case 4: return viewService.buildComponent('page_four');
            case 5: return viewService.buildComponent('page_five');
