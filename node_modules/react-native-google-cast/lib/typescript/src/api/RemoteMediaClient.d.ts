...
export default class RemoteMediaClient {
     ...
     */
    onMediaStatusUpdated(handler: (mediaStatus: MediaStatus) => void): import("react-native").EmitterSubscription;
    /**
     ...
     */
    onMediaPlaybackStarted(handler: (mediaStatus: MediaStatus) => void): import("react-native").EmitterSubscription;
    /**
     ...
     * Note: If you're also subscribed to `onMediaStatusUpdated`, it will be triggered before this event.
     */
    onMediaPlaybackEnded(handler: (mediaStatus: MediaStatus) => void): import("react-native").EmitterSubscription;
}
