...
const StretchyScrollView = React.forwardRef(({ backgroundColor, children, foreground, imageHeight, onScroll, stretchy, style, ...otherProps }, ref) => {
    ...
    return (React.createElement(Animated.ScrollView, Object.assign({}, otherProps, { ref: ref, style: [style, styles.contentContainer], scrollEventThrottle: 1, onScroll: stretchy.onScroll }),
